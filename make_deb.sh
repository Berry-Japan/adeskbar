...
echo "Depends: python (>=2.4), python-gtk2, python-gmenu, python-xdg, gnome-menus" >> $DIR_TEMP/DEBIAN/control
echo "Recommends: python-wnck, python-xlib, python-vte, python-alsaaudio" >> $DIR_TEMP/DEBIAN/control
echo "Maintainer: David Art (david.madbox@gmail.com)" >> $DIR_TEMP/DEBIAN/control
echo "Description: ADeskBar is a Python/Gtk Application Launcher." >> $DIR_TEMP/DEBIAN/control
status
